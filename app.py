...
class App:
    ...
    def __init__(self, window=tk.Tk(), window_title="Waste Classifier"):
    ...
    def init_gui(self):
        ...
        self.classname_three = simpledialog.askstring("Classname Three", "Enter the name of the third class:",
                                                    parent=self.window)
        ...
        self.class_label.config(font=("Times New Roman", 20))
